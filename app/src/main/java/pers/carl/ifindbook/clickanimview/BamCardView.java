package pers.carl.ifindbook.clickanimview;
 ...
 *
 */
public class BamCardView extends MaterialCardView {
    ...
    public BamCardView(Context context, AttributeSet attrs, int defStyle) {
